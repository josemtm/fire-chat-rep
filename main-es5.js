...
module.exports = "<h1>Fire-Chat</h1>\r\n\r\n<hr>\r\n\r\n<div class=\"app-mensajes\" id=\"app-mensajes\">\r\n\r\n    <div [ngClass]=\"{'text-right': _cs.usuario.uid == chat.uid}\" *ngFor=\"let chat of _cs.chats\">\r\n        <span [ngClass]=\"{'badge-primary': _cs.usuario.uid == chat.uid,\r\n        'badge-success': _cs.usuario.uid != chat.uid}\" class=\"badge\">{{chat.nombre}}</span>\r\n        <p>{{chat.mensaje}}</p>\r\n    </div>\r\n\r\n\r\n</div>\r\n\r\n<input class=\"form-control\" type=\"text\" name=\"mensaje\" [(ngModel)]=\"mensaje\" placeholder=\"Enviar mensaje\" (keyup.enter)=\"enviarMensaje()\">"
...
module.exports = "<div class=\"modal-dialog text-center\">\r\n    <div class=\"col-sm-8 main-section\">\r\n        <div class=\"modal-content\">\r\n            <div class=\"col-12 user-img\">\r\n                <img src=\"assets/img/user.png\" />\r\n                <p>Ingrese al chat con su cuenta de Goole</p>\r\n                <button (click)=\"ingresar('google')\" class=\"btn btn-primary\" type=\"button\">Login</button>\r\n            </div>\r\n\r\n\r\n\r\n\r\n        </div>\r\n    </div>\r\n</div>\r\n"
...
/* harmony import */ var _providers_chat_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./providers/chat.service */ "./src/app/providers/chat.service.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_chat_service__WEBPACK_IMPORTED_MODULE_2__["ChatService"]])
    ], AppComponent);
    return AppComponent;
}());
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _angular_fire_auth__WEBPACK_IMPORTED_MODULE_6__["AngularFireAuthModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"]
            ],
            providers: [_providers_chat_service__WEBPACK_IMPORTED_MODULE_10__["ChatService"]],
...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.enviarMensaje = function () {
        ...
        this._cs.agregarMensaje(this.mensaje).then(function () { return _this.mensaje = ""; })
            .catch(function (err) { console.error("error al envia", err); });
    };
...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.cargarMensajes = function () {
        ...
        return this.itemsCollection.valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (resp) {
            console.log(resp);
            _this.chats = [];
            for (var _i = 0, resp_1 = resp; _i < resp_1.length; _i++) {
                var mensaje = resp_1[_i];
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyAzP5qW8Vpl_nBHVE8sM7oZnvAbue5spvg",
        authDomain: "firechat-4f469.firebaseapp.com",
        databaseURL: "https://firechat-4f469.firebaseio.com",
        projectId: "firechat-4f469",
        storageBucket: "firechat-4f469.appspot.com",
        messagingSenderId: "483473629172",
        appId: "1:483473629172:web:76f1316b181a4d22"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\andreina\Desktop\New folder (2)\chatFirebase\src\main.ts */"./src/main.ts");
