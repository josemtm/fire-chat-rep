...
let ChatService = class ChatService {
    ...
    cargarMensajes() {
        this.itemsCollection = this.afs.collection("chats", ref => ref.orderBy("fecha", "desc").limit(5));
        return this.itemsCollection.valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(resp => {
            console.log(resp);
            this.chats = [];
